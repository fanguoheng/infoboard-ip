...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil tagStr:(NSString*)tagStrOrNil delegate:(id<SDBackForwadControllerDelegate>)delegateOrNil
{
    [self initWithNibName:nibNameOrNil bundle:nibBundleOrNil tagStr:tagStrOrNil];
